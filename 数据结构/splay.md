...
![image-20211109211529465](https://raw.githubusercontent.com/Falicitas/Image-Hosting/main/image-20211109211529465.png)
...
![image-20211109211614387](https://raw.githubusercontent.com/Falicitas/Image-Hosting/main/image-20211109211614387.png)

- 如果 $x$ 的父亲不是根节点，且 $x$ 和父亲的儿子类型相同，首先将其父亲左旋或右旋，然后将 $x$ 右旋或左旋（图 $3,4$）。

![image-20211109211627181](https://raw.githubusercontent.com/Falicitas/Image-Hosting/main/image-20211109211627181.png)

- 如果 $x$ 的父亲不是根节点，且 $x$ 和父亲的儿子类型不同，将 $x$ 左旋再右旋、或者右旋再左旋（图 $5,6$）。

![image-20211109211641210](https://raw.githubusercontent.com/Falicitas/Image-Hosting/main/image-20211109211641210.png)
