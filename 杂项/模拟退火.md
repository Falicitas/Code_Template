...
![simulated-annealing](https://raw.githubusercontent.com/Falicitas/Image-Hosting/main/simulated-annealing.gif)
...
$f_{i,j,k} = \min\{f_{i-1,j-1,k-1*d},f_{i-1,j,k-2*d}+1\}$ 